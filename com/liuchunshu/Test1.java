...
public class Test1 {
    ...
    public static void main(String[] args) {  
        ...
        System.out.println("method6 :" + (d6 - s6));//method6 :30568602 
...
//    	String[] ar_str1, ar_str2;  
    	int[] ar_str1=new int[4], ar_str2=new int[4]; 
//        int sum = 0;  
        int from;  
        int to;  
        int i_val;  
...
//            ar_str2 = (String.valueOf(i) + String.valueOf(j)).split("");  
            ...
            ar_str1[2] = j / 10;  
            ar_str1[3] = j % 10;  
            ar_str2[0] = i_val / 1000;  
            ar_str2[1] = (i_val % 1000) / 100;  
            ar_str2[2] = i_val % 1000 % 100 / 10;  
            ar_str2[3] = i_val % 1000 % 100 % 10;  
            int count = 0;  
            for (int x = 0; x < 4; x++)  
                for (int y = 0; y < 4; y++) {  
                    if (ar_str2[x] == ar_str1[y]) {  
                        count++;  
                        ar_str2[x] = -1;  
                        ar_str1[y] = -2;  
                        if (count == 4)  
...
//        System.out.println(count); 
    ...
    private static boolean comparelist(int[] a,int[] b){
    	int count = 0;  
        for (int x = 0; x < 4; x++)  
            for (int y = 0; y < 4; y++) {  
                if (a[x] == b[y]) {  
